  ...
  return (
    ...
    <form onSubmit={handleSubmit}>
     ...
     <label>
      ...
      <div className="flex place-items-left grid text-left lg:max-w-5xl lg:w-full lg:mb-0 lg:grid-cols-4 lg:text-left mt-3">
       <label className="bg-transparent p-0 rounded-md appearance-none mx-0">
        <input type="checkbox" value="붉어짐" onChange={handleSymptomChange} checked={localPatientData.symptom.includes('붉어짐')} />
        붉어짐
      </label>
      <label className="bg-transparent p-0 rounded-md appearance-none mr-2">
      ...
      <br/>
      <div className="flex place-items-left grid text-left lg:max-w-5xl lg:w-full lg:mb-0 lg:grid-cols-4 lg:text-left mt-3">
      <label className="bg-transparent p-0 rounded-md appearance-none">
